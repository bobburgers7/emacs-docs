...
Some people find the many stars too noisy and would prefer an outline that has whitespace followed by a single star as headline starters. This can be achieved using an Org Indent minor mode. See [A Cleaner Outline View](/docs/org/Clean-View) for more information.
