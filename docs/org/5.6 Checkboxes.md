...
[^2]: Set the variable `org-checkbox-hierarchical-statistics` if you want such cookies to count all checkboxes below the cookie, not just those belonging to direct children.
