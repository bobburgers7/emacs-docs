...
For archiving, the ‘`ARCHIVE`’ property may define the archive location for the entire subtree (see [Moving a tree to an archive file](/docs/org/Moving-subtrees)).
