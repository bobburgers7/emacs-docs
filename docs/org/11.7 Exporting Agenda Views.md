...
[^1]: For HTML you need to install Hrvoje Nikšić’s ‘`htmlize.el`’ as an Emacs package from [NonGNU ELPA](https://elpa.nongnu.org/) or from [Hrvoje Nikšić’s repository](https://github.com/hniksic/emacs-htmlize).
