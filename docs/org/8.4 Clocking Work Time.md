...
When you clock into a new task after resuming Emacs, the incomplete clock[^2] is retrieved (see [Resolving idle time (1)](/docs/org/Resolving-idle-time)) and you are prompted about what to do with it.

*   [Clocking commands](/docs/org/Clocking-commands)
*   [The clock table](/docs/org/The-clock-table)
*   [Resolving idle time and continuous clocking](/docs/org/Resolving-idle-time)
