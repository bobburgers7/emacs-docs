...
Alternatively, by using TRAMP (see [TRAMP User Manual](https://www.gnu.org/software/emacs/manual/html_mono/tramp.html#Top)), `org-mobile-directory` may point to a remote directory accessible through, for example, SSH, SCP, or DAVS:
