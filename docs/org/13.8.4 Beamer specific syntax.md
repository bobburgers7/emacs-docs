...
Since Org’s Beamer export backend is an extension of the LaTeX backend, it recognizes other LaTeX specific syntax—for example, ‘`#+LATEX:`’ or ‘`#+ATTR_LATEX:`’. See [LaTeX Export](/docs/org/LaTeX-Export), for details.
