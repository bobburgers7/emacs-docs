...
*   [LaTeX math snippets](/docs/org/Math-formatting-in-ODT-export)
*   [MathML and OpenDocument formula files](/docs/org/Math-formatting-in-ODT-export)
...
[^1]: See [MathToWeb](https://mathtoweb.sourceforge.io/).

[^2]: See [https://dlmf.nist.gov/LaTeXML/](https://dlmf.nist.gov/LaTeXML/).
