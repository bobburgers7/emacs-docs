...
Calc also contains a complete set of logical operations (see [Logical Operations](https://www.gnu.org/software/emacs/manual/html_mono/calc.html#Logical-Operations)). For example
