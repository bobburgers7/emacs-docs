...
The ASCII export backend has one extra keyword for customizing ASCII output. Setting this keyword works similar to the general options (see [Export Settings](/docs/org/Export-Settings)).
...
Besides ‘`#+BEGIN_CENTER`’ blocks (see [Paragraphs](/docs/org/Paragraphs)), ASCII backend has these two left and right justification blocks:
