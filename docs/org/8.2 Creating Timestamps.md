...
Change date at point by one day. These key bindings conflict with shift-selection and related modes (see [Packages that conflict with Org mode](/docs/org/Conflicts)).
...
*   [The date/time prompt](/docs/org/The-date_002ftime-prompt)
*   [Custom time format](/docs/org/Custom-time-format)
