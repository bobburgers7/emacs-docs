...
`org-agenda-loop-over-headlines-in-active-region` is the equivalent option of the agenda buffer, where you can also use [bulk editing of selected entries](/docs/org/Agenda-Commands).
