...
This macro returns the value of property `PROPERTY-NAME` in the current entry. If `SEARCH-OPTION` (see [Search Options in File Links](/docs/org/Search-Options)) refers to a remote entry, use it instead.
