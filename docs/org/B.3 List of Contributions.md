...
*   Timothy E Chapman worked on a complete overhaul of the orgmode.org website in 2020 and helped fixing various bugs.
...
*   Kyle Meyer helped setting up the [public-inbox](https://public-inbox.org/) archive of the [Org mailing list](https://orgmode.org/list/) and has been fixing many bugs.
...
*   Ihor Radchenko helped with fixing bugs and improving the user experience regarding Org’s speed.
...
*   Stathis Sideris wrote the ‘`ditaa.jar`’ ASCII to PNG converter that is now packaged into the [org-contrib](https://git.sr.ht/~bzg/org-contrib) repository.
